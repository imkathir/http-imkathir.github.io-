...
define('testapp/tests/lint/app.lint-test', [], function () {
  'use strict';
...
define('testapp/tests/lint/templates.template.lint-test', [], function () {
  'use strict';

  QUnit.module('TemplateLint');

  QUnit.test('testapp/templates/application.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'testapp/templates/application.hbs should pass TemplateLint.\n\ntestapp/templates/application.hbs\n  2:4  error  Incorrect indentation for `<h1>` beginning at L2:C4. Expected `<h1>` to be at an indentation of 2 but was found at 4.  block-indentation\n  3:4  error  Incorrect indentation for `{{outlet}}` beginning at L3:C4. Expected `{{outlet}}` to be at an indentation of 2 but was found at 4.  block-indentation\n');
  });
});
define('testapp/tests/lint/tests.lint-test', [], function () {
  'use strict';
